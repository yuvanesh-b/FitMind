...
export const WorkoutSummaryModal: React.FC<WorkoutSummaryModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-[var(--bg-card)] border border-brand-500/40 rounded-2xl p-6 shadow-2xl space-y-5 text-center relative">
        <div className="w-16 h-16 rounded-2xl bg-brand-600/20 border border-brand-500/40 text-brand-400 flex items-center justify-center mx-auto shadow-lg shadow-brand-600/30">
          <Trophy className="w-8 h-8" />
        </div>

        <div>
          <span className="text-[10px] font-extrabold uppercase tracking-wider text-brand-400">Workout Complete</span>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <div className="p-3.5 rounded-xl bg-[var(--bg-surface)] border border-[var(--border-subtle)] text-center">
            ...
            <span className="text-lg font-black text-accent-emerald flex items-center justify-center gap-1">
          ...
          <div className="p-3.5 rounded-xl bg-[var(--bg-surface)] border border-[var(--border-subtle)] text-center">
            ...
            <span className="text-lg font-black text-accent-amber flex items-center justify-center gap-1">
        ...
        <button
          onClick={onClose}
          className="w-full py-3.5 rounded-xl font-extrabold bg-brand-600 hover:bg-brand-500 text-white text-xs shadow-lg shadow-brand-600/30 flex items-center justify-center gap-2 transition-all mt-2"
        >
